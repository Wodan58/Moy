...
/* 2560 */ { Q1, OK, "binary", binary_, "DDDA", "X Y [P]  ->  R", "Executes P, which leaves R on top of the stack.\nNo matter how many parameters this consumes,\nexactly two are removed from the stack.\n" },
...
/* 2830 */ { Q1, OK, "filter", filter_, "DDA", "A [B]  ->  A1", "Uses test B to filter aggregate A producing sametype aggregate A1.\n" },
