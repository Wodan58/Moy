...
2018-06-28 - builtin.h and runtime.c are now also generated by the build
environment; updating CMakeLists.txt is not needed anymore.

2018-06-30 - parse.y has lost all DO\_ definitions and that also means that
...
with /\*\* and extending over a minimum of 8 lines.
